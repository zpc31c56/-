        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="registrationform">
                <div class="form-horizontal">
                    <fieldset>
                        <legend>註冊 <i class="fa fa-pencil pull-right"></i></legend>
                        ...
                        <div class="form-group">
                            <asp:Label ID="Label4" runat="server" Text="性別" CssClass="col-lg-2 control-label"></asp:Label>
                            <div class="col-lg-10">
                                <div class="radio">
                                    <label>
                        ...
                        <div class="form-group">
                          <asp:Label ID="Label5" runat="server" Text="註冊身份" CssClass="col-lg-2 control-label"></asp:Label>                          
                            <div class="col-lg-10">
                                <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control ddl">
                                    ...
                                    <asp:ListItem>公司業主</asp:ListItem>
                                </asp:DropDownList>                              
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-lg-10 col-lg-offset-2">
                                <asp:Button ID="btnSubmit" runat="server" onclick="btnOK_Click" CssClass="btn btn-primary" Text="註冊" Width="115px" />
