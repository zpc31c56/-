...
public partial class preview_dotnet_templates_registration_Form_index : System.Web.UI.Page
{
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        ...
        objcommand.CommandText = "Select * From accountID Where Name = '" + TextBox1.Text + "' and  Pass ='" + TextBox2.Text + "' and  Idt = '公司業主'";
        ...
        try
       {
            ...
            if (apcheck.HasRows)
            {
                ...
                //傳統寫法
                Response.Redirect("ShowData.aspx?ID=" + TextBox1.Text + "&Password=" + TextBox2.Text + "&Msg=3");
